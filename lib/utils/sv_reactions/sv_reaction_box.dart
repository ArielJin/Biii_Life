...
import 'package:Biii_Life/utils/sv_reactions/sv_extension.dart';
import 'package:Biii_Life/utils/sv_reactions/sv_reaction.dart';
...
class _ReactionsBoxState extends State<ReactionsBox> with TickerProviderStateMixin {
  ...
  double _getPosition(BuildContext context) => (_getTopPosition() - widget.buttonSize.height * 2 < 0)
      ? _getBottomPosition()
