...
class Author {
  ...
  Author({this.avatar_urls, this.description, this.id, this.is_super_admin, this.link, this.name, this.slug, this.url, this.is_user_verified});
...
class FeaturedMedia {
  ...
  FeaturedMedia({this.alt_text, this.author, this.caption, this.date, this.id, this.link, this.media_type, this.mime_type, this.slug, this.source_url, this.title, this.type});
