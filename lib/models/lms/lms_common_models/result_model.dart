import 'package:Biii_Life/models/lms/lms_common_models/result_items_model.dart';
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) {
    return Result(
      ...
      items: (json['items'] != null && json['items'].runtimeType != List<dynamic>) ? Items.fromJson(json['items']) : null,
      pass: json['pass'],
      result: json['result'],
    );
  }
