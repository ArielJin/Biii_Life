...
import 'package:Biii_Life/models/woo_commerce/shipping_lines.dart';
...
class OrderModel {
  ...
  String? cartHash;
  String? cartTax;
  List<OrderCouponModel>? couponLines;
  String? createdVia;
  String? currency;
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    return OrderModel(
      ...
      couponLines: json['coupon_lines'] != null ? (json['coupon_lines'] as List).map((i) => OrderCouponModel.fromJson(i)).toList() : null,
...
class OrderCouponModel {
  ...
  OrderCouponModel.fromJson(dynamic json) {
    id = json['id'];
    code = json['code'];
