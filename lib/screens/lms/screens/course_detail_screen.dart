...
import 'package:Biii_Life/models/lms/course_list_model.dart';
import 'package:Biii_Life/network/lms_rest_apis.dart';
import 'package:Biii_Life/screens/lms/components/course_card_component.dart';
import 'package:Biii_Life/screens/lms/components/course_includes_tab_component.dart';
import 'package:Biii_Life/screens/lms/components/curriculam_tab_component.dart';
import 'package:Biii_Life/screens/lms/components/faq_tab_component.dart';
import 'package:Biii_Life/screens/lms/components/instructor_tab_component.dart';
import 'package:Biii_Life/screens/lms/components/overview_tab_component.dart';
import 'package:Biii_Life/screens/lms/components/review_tab_component.dart';
import 'package:Biii_Life/screens/lms/components/start_course_widget.dart';
import 'package:Biii_Life/screens/lms/screens/buy_course_screen.dart';
import 'package:Biii_Life/screens/lms/screens/course_sections_screen.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        if (course!.course_data!.status == CourseStatus.enrolled && course!.course_data!.graduation == CourseStatus.inProgress)
                          Row(
                            children: [
                              Text('${language.courseResults}: ${course!.course_data!.result!.result.validate()}%', style: boldTextStyle()).paddingSymmetric(horizontal: 16),
                              SizedBox(
