      ...
      children: [
        ...
        if (requirements.validate().isNotEmpty)
          ExpansionTile(
            ...
            title: Text(language.requirements,style: primaryTextStyle()),
        ...
        if (features.validate().isNotEmpty)
          ExpansionTile(
            textColor: context.primaryColor,
            childrenPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
            title: Text(language.features,style: primaryTextStyle()),
        ...
        if (audiences.validate().isNotEmpty)
          ExpansionTile(
            textColor: context.primaryColor,
            childrenPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
            title: Text(language.targetAudiences,style: primaryTextStyle()),
