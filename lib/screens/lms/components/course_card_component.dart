...
import 'package:Biii_Life/screens/lms/components/price_widget.dart';
import 'package:Biii_Life/screens/lms/screens/course_detail_screen.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        4.width,
                        Text('${course.count_students.validate().toString()} ${language.students}', style: secondaryTextStyle()),
                      ],
                    ),
                    Row(
                      mainAxisSize: MainAxisSize.min,
