...
import 'package:Biii_Life/screens/messages/components/message_member_component.dart';
              ...
              ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  ...
                  if (thread.participantsCount.validate() >= 2) {
                    user = widget.searchResponse.updateData!.users.validate().firstWhere((element) => element.userId == thread.participants!.first);
                  } else {
