...
import 'package:Biii_Life/screens/settings/screens/pending_invites_screen.dart';
...
class _PendingInvitesCardComponentState extends State<PendingInvitesCardComponent> {
  ...
  void initState() {
    super.initState();
    formattedDate = DateFormat(DATE_FORMAT_3).format(DateTime.parse(widget.inviteList.dateModified.validate().substring(0, 10)));
  }
