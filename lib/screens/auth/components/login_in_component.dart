...
import 'package:Biii_Life/screens/auth/screens/otp_login_screen.dart';
import 'package:Biii_Life/screens/auth/screens/forget_password_screen.dart';
      ...
      builder: (_) => Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              16.height,
              Text(language.welcomeBack, style: boldTextStyle(size: 24, color: textSecondaryColor)).paddingSymmetric(horizontal: 16),
              8.height,
              Text(
