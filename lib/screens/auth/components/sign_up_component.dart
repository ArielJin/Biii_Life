...
import 'package:Biii_Life/screens/auth/components/successful_activation_dialog.dart';
import 'package:Biii_Life/screens/auth/components/verify_auth_key_component.dart';
import 'package:Biii_Life/screens/dashboard_screen.dart';
import 'package:Biii_Life/screens/profile/components/expansion_body.dart';
import 'package:Biii_Life/screens/profile/components/profile_field_component.dart';
      ...
      builder: (_) => Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              16.height,
              Text(language.helloUser, style: boldTextStyle(size: 24, color: textSecondaryColor)).paddingSymmetric(horizontal: 16),
              8.height,
                  ...
                  child: Column(
                    children: [
                      ...
                      AppTextField(
                        ...
                        textStyle: boldTextStyle(color: textSecondaryColor),
