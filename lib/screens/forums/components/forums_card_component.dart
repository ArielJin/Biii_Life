  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(parseHtmlString(title.validate()), style: boldTextStyle(size: 18)),
          8.height,
          Text(description.validate(), style: secondaryTextStyle(), maxLines: 5, overflow: TextOverflow.ellipsis),
          Divider(),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
